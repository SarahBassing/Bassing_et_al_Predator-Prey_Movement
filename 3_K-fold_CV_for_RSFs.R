  ...
  #'  Read in study area grids (using 1km^2 grids because 30m^2 grids computationally 
  #'  prohibitive with standard computer)
  ...
  load("./Outputs/Telemetry_covs/NE_covariates_1km.RData") 
  load("./Outputs/Telemetry_covs/OK_covariates_1km.RData")
  ...
  #'  Used global model, only removing highly correlated variables when needed
  ...
  save(md_kfold_smr, file = "./Outputs/RSF_output/Kfold_CV/md_kfold_smr.RData")
  save(md_kfold_wtr, file = "./Outputs/RSF_output/Kfold_CV/md_kfold_wtr.RData")
  ...
  save(elk_kfold_smr, file = "./Outputs/RSF_output/Kfold_CV/elk_kfold_smr.RData")
  save(elk_kfold_wtr, file = "./Outputs/RSF_output/Kfold_CV/elk_kfold_wtr.RData")
  ...
  save(wtd_kfold_smr, file = "./Outputs/RSF_output/Kfold_CV/wtd_kfold_smr.RData")
  save(wtd_kfold_wtr, file = "./Outputs/RSF_output/Kfold_CV/wtd_kfold_wtr.RData")
  ...
  save(coug_kfold_smr_OK, file = "./Outputs/RSF_output/Kfold_CV/coug_kfold_smr_OK.RData")
  save(coug_kfold_smr_NE, file = "./Outputs/RSF_output/Kfold_CV/coug_kfold_smr_NE.RData")
  save(coug_kfold_wtr_OK, file = "./Outputs/RSF_output/Kfold_CV/coug_kfold_wtr_OK.RData")
  save(coug_kfold_wtr_NE, file = "./Outputs/RSF_output/Kfold_CV/coug_kfold_wtr_NE.RData")
  ...
  save(wolf_kfold_smr_OK, file = "./Outputs/RSF_output/Kfold_CV/wolf_kfold_smr_OK.RData")
  save(wolf_kfold_smr_NE, file = "./Outputs/RSF_output/Kfold_CV/wolf_kfold_smr_NE.RData")
  save(wolf_kfold_wtr_OK, file = "./Outputs/RSF_output/Kfold_CV/wolf_kfold_wtr_OK.RData")
  save(wolf_kfold_wtr_NE, file = "./Outputs/RSF_output/Kfold_CV/wolf_kfold_wtr_NE.RData")
  ...
  coug_smr_OK_zcovs <- lapply(SA.covs_list, scaling_covs, mu.sd = cougCov_smr_OK_summary)
  coug_smr_NE_zcovs <- lapply(SA.covs_list, scaling_covs, mu.sd = cougCov_smr_NE_summary)
  coug_wtr_OK_zcovs <- lapply(SA.covs_list_reclass, scaling_covs, mu.sd = cougCov_wtr_OK_summary)
  coug_wtr_NE_zcovs <- lapply(SA.covs_list_reclass, scaling_covs, mu.sd = cougCov_wtr_NE_summary)
  wolf_smr_OK_zcovs <- lapply(SA.covs_list_wolf_reclass, scaling_covs, mu.sd = wolfCov_smr_OK_summary)
  wolf_smr_NE_zcovs <- lapply(SA.covs_list_wolf_reclass, scaling_covs, mu.sd = wolfCov_smr_NE_summary)
  wolf_wtr_OK_zcovs <- lapply(SA.covs_list_wolf_reclass, scaling_covs, mu.sd = wolfCov_wtr_OK_summary)
  wolf_wtr_NE_zcovs <- lapply(SA.covs_list_wolf_reclass, scaling_covs, mu.sd = wolfCov_wtr_NE_summary)
  
  #'  Read in saved k-fold trained model results
  load("./Outputs/RSF_output/Kfold_CV/md_kfold_smr.RData") 
  load("./Outputs/RSF_output/Kfold_CV/md_kfold_wtr.RData")
  load("./Outputs/RSF_output/Kfold_CV/elk_kfold_smr.RData")
  load("./Outputs/RSF_output/Kfold_CV/elk_kfold_wtr.RData")
  load("./Outputs/RSF_output/Kfold_CV/wtd_kfold_smr.RData")
  load("./Outputs/RSF_output/Kfold_CV/wtd_kfold_wtr.RData")
  load("./Outputs/RSF_output/Kfold_CV/coug_kfold_smr.RData")
  load("./Outputs/RSF_output/Kfold_CV/coug_kfold_smr.RData")
  load("./Outputs/RSF_output/Kfold_CV/coug_kfold_wtr.RData")
  load("./Outputs/RSF_output/Kfold_CV/coug_kfold_wtr.RData")
  load("./Outputs/RSF_output/Kfold_CV/wolf_kfold_smr.RData")
  load("./Outputs/RSF_output/Kfold_CV/wolf_kfold_smr.RData")
  load("./Outputs/RSF_output/Kfold_CV/wolf_kfold_wtr.RData")
  load("./Outputs/RSF_output/Kfold_CV/wolf_kfold_wtr.RData")
  ...
  coug_smr_OK_trainout <- lapply(coug_kfold_smr_OK, rsf_out, spp = "Cougar OK", season = "Summer")
  coug_smr_NE_trainout <- lapply(coug_kfold_smr_NE, rsf_out, spp = "Cougar NE", season = "Summer")
  coug_wtr_OK_trainout <- lapply(coug_kfold_wtr_OK, rsf_out, spp = "Cougar OK", season = "Winter")
  coug_wtr_NE_trainout <- lapply(coug_kfold_wtr_NE, rsf_out, spp = "Cougar NE", season = "Winter")
  wolf_smr_OK_trainout <- lapply(wolf_kfold_smr_OK, rsf_out, spp = "Wolf OK", season = "Summer")
  wolf_smr_NE_trainout <- lapply(wolf_kfold_smr_NE, rsf_out, spp = "Wolf NE", season = "Summer")
  wolf_wtr_OK_trainout <- lapply(wolf_kfold_wtr_OK, rsf_out, spp = "Wolf OK", season = "Winter")
  wolf_wtr_NE_trainout <- lapply(wolf_kfold_wtr_NE, rsf_out, spp = "Wolf NE", season = "Winter")
  
  #'  Function to predict across all grid cells based on RSF results
  #'  Should end up with 1 predicted value per grid cell
  #'  NOTE: I want the predict relative probability of selection from RSF so 
  #'  dropping the intercept from the model and just exponentiating the 
  ...
  save(md_smr_Kpredict, file = "./Outputs/RSF_output/Kfold_CV/md_smr_Kpredict.RData")
  ...
  save(md_wtr_Kpredict, file = "./Outputs/RSF_output/Kfold_CV/md_wtr_Kpredict.RData")
  ...
  save(elk_smr_Kpredict, file = "./Outputs/RSF_output/Kfold_CV/elk_smr_Kpredict.RData")
  ...
  save(elk_wtr_Kpredict, file = "./Outputs/RSF_output/Kfold_CV/elk_wtr_Kpredict.RData")
  ...
  save(wtd_smr_Kpredict, file = "./Outputs/RSF_output/Kfold_CV/wtd_smr_Kpredict.RData")
  ...
  save(wtd_wtr_Kpredict, file = "./Outputs/RSF_output/Kfold_CV/wtd_wtr_Kpredict.RData")
  coug_smr18_OK_Kpredict <- lapply(coug_smr_OK_trainout, predict_rsf, cov = coug_smr_OK_zcovs[[1]])
  coug_smr19_OK_Kpredict <- lapply(coug_smr_OK_trainout, predict_rsf, cov = coug_smr_OK_zcovs[[2]])
  coug_smr20_OK_Kpredict <- lapply(coug_smr_OK_trainout, predict_rsf, cov = coug_smr_OK_zcovs[[3]])
  coug_smr_OK_Kpredict <- list(coug_smr18_OK_Kpredict, coug_smr19_OK_Kpredict, coug_smr20_OK_Kpredict)
  save(coug_smr_OK_Kpredict, file = "./Outputs/RSF_output/Kfold_CV/coug_smr_OK_Kpredict.RData")
  coug_smr18_NE_Kpredict <- lapply(coug_smr_NE_trainout, predict_rsf, cov = coug_smr_NE_zcovs[[1]])
  coug_smr19_NE_Kpredict <- lapply(coug_smr_NE_trainout, predict_rsf, cov = coug_smr_NE_zcovs[[2]])
  coug_smr20_NE_Kpredict <- lapply(coug_smr_NE_trainout, predict_rsf, cov = coug_smr_NE_zcovs[[3]])
  coug_smr_NE_Kpredict <- list(coug_smr18_NE_Kpredict, coug_smr19_NE_Kpredict, coug_smr20_NE_Kpredict)
  save(coug_smr_NE_Kpredict, file = "./Outputs/RSF_output/Kfold_CV/coug_smr_NE_Kpredict.RData")
  coug_wtr1819_OK_Kpredict <- lapply(coug_wtr_OK_trainout, predict_rsf, cov = coug_wtr_OK_zcovs[[1]])
  coug_wtr1920_OK_Kpredict <- lapply(coug_wtr_OK_trainout, predict_rsf, cov = coug_wtr_OK_zcovs[[2]])
  coug_wtr2021_OK_Kpredict <- lapply(coug_wtr_OK_trainout, predict_rsf, cov = coug_wtr_OK_zcovs[[3]])
  coug_wtr_OK_Kpredict <- list(coug_wtr1819_OK_Kpredict, coug_wtr1920_OK_Kpredict, coug_wtr2021_OK_Kpredict)
  save(coug_wtr_OK_Kpredict, file = "./Outputs/RSF_output/Kfold_CV/coug_wtr_OK_Kpredict.RData")
  coug_wtr1819_NE_Kpredict <- lapply(coug_wtr_NE_trainout, predict_rsf, cov = coug_wtr_NE_zcovs[[1]])
  coug_wtr1920_NE_Kpredict <- lapply(coug_wtr_NE_trainout, predict_rsf, cov = coug_wtr_NE_zcovs[[2]])
  coug_wtr2021_NE_Kpredict <- lapply(coug_wtr_NE_trainout, predict_rsf, cov = coug_wtr_NE_zcovs[[3]])
  coug_wtr_NE_Kpredict <- list(coug_wtr1819_NE_Kpredict, coug_wtr1920_NE_Kpredict, coug_wtr2021_NE_Kpredict)
  save(coug_wtr_NE_Kpredict, file = "./Outputs/RSF_output/Kfold_CV/coug_wtr_NE_Kpredict.RData")
  wolf_smr18_OK_Kpredict <- lapply(wolf_smr_OK_trainout, predict_rsf, cov = wolf_smr_OK_zcovs[[1]])
  wolf_smr19_OK_Kpredict <- lapply(wolf_smr_OK_trainout, predict_rsf, cov = wolf_smr_OK_zcovs[[2]])
  wolf_smr20_OK_Kpredict <- lapply(wolf_smr_OK_trainout, predict_rsf, cov = wolf_smr_OK_zcovs[[3]])
  wolf_smr_OK_Kpredict <- list(wolf_smr18_OK_Kpredict, wolf_smr19_OK_Kpredict, wolf_smr20_OK_Kpredict)
  save(wolf_smr_OK_Kpredict, file = "./Outputs/RSF_output/Kfold_CV/wolf_smr_OK_Kpredict.RData")
  wolf_smr18_NE_Kpredict <- lapply(wolf_smr_NE_trainout, predict_rsf, cov = wolf_smr_NE_zcovs[[1]])
  wolf_smr19_NE_Kpredict <- lapply(wolf_smr_NE_trainout, predict_rsf, cov = wolf_smr_NE_zcovs[[2]])
  wolf_smr20_NE_Kpredict <- lapply(wolf_smr_NE_trainout, predict_rsf, cov = wolf_smr_NE_zcovs[[3]])
  wolf_smr_NE_Kpredict <- list(wolf_smr18_NE_Kpredict, wolf_smr19_NE_Kpredict, wolf_smr20_NE_Kpredict)
  save(wolf_smr_NE_Kpredict, file = "./Outputs/RSF_output/Kfold_CV/wolf_smr_NE_Kpredict.RData")
  wolf_wtr1819_OK_Kpredict <- lapply(wolf_wtr_OK_trainout, predict_rsf, cov = wolf_wtr_OK_zcovs[[1]])
  wolf_wtr1920_OK_Kpredict <- lapply(wolf_wtr_OK_trainout, predict_rsf, cov = wolf_wtr_OK_zcovs[[2]])
  wolf_wtr2021_OK_Kpredict <- lapply(wolf_wtr_OK_trainout, predict_rsf, cov = wolf_wtr_OK_zcovs[[3]])
  wolf_wtr_OK_Kpredict <- list(wolf_wtr1819_OK_Kpredict, wolf_wtr1920_OK_Kpredict, wolf_wtr2021_OK_Kpredict)
  save(wolf_wtr_OK_Kpredict, file = "./Outputs/RSF_output/Kfold_CV/wolf_wtr_OK_Kpredict.RData")
  ...
  save(wolf_wtr_NE_Kpredict, file = "./Outputs/RSF_output/Kfold_CV/wolf_wtr_NE_Kpredict.RData")
  ...
  md_smr_Koutliers <- lapply(md_smr_Kpredict, lapply, outliers, title = "Mule Deer Summer K-fold Predictions") 
  ...
  coug_smr_OK_Koutliers <- lapply(coug_smr_OK_Kpredict, lapply, outliers, title = "Cougar Summer OK K-fold Predictions") 
  coug_smr_NE_Koutliers <- lapply(coug_smr_NE_Kpredict, lapply, outliers, title = "Cougar Summer NE K-fold Predictions") 
  coug_wtr_OK_Koutliers <- lapply(coug_wtr_OK_Kpredict, lapply, outliers, title = "Cougar Winter OK K-fold Predictions")
  coug_wtr_NE_Koutliers <- lapply(coug_wtr_NE_Kpredict, lapply, outliers, title = "Cougar Winter NE K-fold Predictions")
  wolf_smr_OK_Koutliers <- lapply(wolf_smr_OK_Kpredict, lapply, outliers, title = "Wolf Summer OK K-fold Predictions") 
  wolf_smr_NE_Koutliers <- lapply(wolf_smr_NE_Kpredict, lapply, outliers, title = "Wolf Summer NE K-fold Predictions") 
  wolf_wtr_OK_Koutliers <- lapply(wolf_wtr_OK_Kpredict, lapply, outliers, title = "Wolf Winter OK K-fold Predictions")
  wolf_wtr_NE_Koutliers <- lapply(wolf_wtr_NE_Kpredict, lapply, outliers, title = "Wolf Winter NE K-fold Predictions")
  ...
  coug_smr_OK_Krsf <- lapply(coug_smr_OK_Koutliers, lapply, RSF_rescale)
  coug_smr_NE_Krsf <- lapply(coug_smr_NE_Koutliers, lapply, RSF_rescale)
  coug_wtr_OK_Krsf <- lapply(coug_wtr_OK_Koutliers, lapply, RSF_rescale)
  coug_wtr_NE_Krsf <- lapply(coug_wtr_NE_Koutliers, lapply, RSF_rescale)
  wolf_smr_OK_Krsf <- lapply(wolf_smr_OK_Koutliers, lapply, RSF_rescale)
  wolf_smr_NE_Krsf <- lapply(wolf_smr_NE_Koutliers, lapply, RSF_rescale)
  wolf_wtr_OK_Krsf <- lapply(wolf_wtr_OK_Koutliers, lapply, RSF_rescale)
  wolf_wtr_NE_Krsf <- lapply(wolf_wtr_NE_Koutliers, lapply, RSF_rescale)
  ...
  coug_smr_OK_Kfoldraster <- lapply(coug_smr_OK_Krsf, lapply, rasterize_rsf)
  coug_smr_NE_Kfoldraster <- lapply(coug_smr_NE_Krsf, lapply, rasterize_rsf)
  coug_wtr_OK_Kfoldraster <- lapply(coug_wtr_OK_Krsf, lapply, rasterize_rsf)
  coug_wtr_NE_Kfoldraster <- lapply(coug_wtr_NE_Krsf, lapply, rasterize_rsf)
  wolf_smr_OK_Kfoldraster <- lapply(wolf_smr_OK_Krsf, lapply, rasterize_rsf)
  wolf_smr_NE_Kfoldraster <- lapply(wolf_smr_NE_Krsf, lapply, rasterize_rsf)
  wolf_wtr_OK_Kfoldraster <- lapply(wolf_wtr_OK_Krsf, lapply, rasterize_rsf)
  wolf_wtr_NE_Kfoldraster <- lapply(wolf_wtr_NE_Krsf, lapply, rasterize_rsf)
  ...
  coug_smr_OK_Kbins <- lapply(coug_smr_OK_Kfoldraster, lapply, bin_rsf, season = "Summer OK", species = "Cougar")
  coug_smr_NE_Kbins <- lapply(coug_smr_NE_Kfoldraster, lapply, bin_rsf, season = "Summer NE", species = "Cougar")
  coug_wtr_OK_Kbins <- lapply(coug_wtr_OK_Kfoldraster, lapply, bin_rsf, season = "Winter OK", species = "Cougar")
  coug_wtr_NE_Kbins <- lapply(coug_wtr_NE_Kfoldraster, lapply, bin_rsf, season = "Winter NE", species = "Cougar")
  wolf_smr_OK_Kbins <- lapply(wolf_smr_OK_Kfoldraster, lapply, bin_rsf, season = "Summer OK", species = "Wolf")
  wolf_smr_NE_Kbins <- lapply(wolf_smr_NE_Kfoldraster, lapply, bin_rsf, season = "Summer NE", species = "Wolf")
  wolf_wtr_OK_Kbins <- lapply(wolf_wtr_OK_Kfoldraster, lapply, bin_rsf, season = "Winter OK", species = "Wolf")
  wolf_wtr_NE_Kbins <- lapply(wolf_wtr_NE_Kfoldraster, lapply, bin_rsf, season = "Winter NE", species = "Wolf")
 
  #'  View bin categories
  unique(wolf_smr_NE_Kbins[[1]][[1]]@data@values)
  ...
  coug_smr_OK_karea <- lapply(coug_smr_OK_Kbins, lapply, calc_bin_area)
  coug_smr_NE_karea <- lapply(coug_smr_NE_Kbins, lapply, calc_bin_area)
  coug_wtr_OK_karea <- lapply(coug_wtr_OK_Kbins, lapply, calc_bin_area)
  coug_wtr_NE_karea <- lapply(coug_wtr_NE_Kbins, lapply, calc_bin_area)
  wolf_smr_OK_karea <- lapply(wolf_smr_OK_Kbins, lapply, calc_bin_area)
  wolf_smr_NE_karea <- lapply(wolf_smr_NE_Kbins, lapply, calc_bin_area)
  wolf_wtr_OK_karea <- lapply(wolf_wtr_OK_Kbins, lapply, calc_bin_area)
  wolf_wtr_NE_karea <- lapply(wolf_wtr_NE_Kbins, lapply, calc_bin_area)
  ...
  load("./Outputs/RSF_output/Kfold_CV/cougData_smr_OK_TestData.RData")
  load("./Outputs/RSF_output/Kfold_CV/cougData_smr_NE_TestData.RData")
  load("./Outputs/RSF_output/Kfold_CV/cougData_wtr_OK_TestData.RData")
  load("./Outputs/RSF_output/Kfold_CV/cougData_wtr_NE_TestData.RData")
  load("./Outputs/RSF_output/Kfold_CV/wolfData_smr_OK_TestData.RData")
  load("./Outputs/RSF_output/Kfold_CV/wolfData_smr_NE_TestData.RData")
  load("./Outputs/RSF_output/Kfold_CV/wolfData_wtr_OK_TestData.RData")
  load("./Outputs/RSF_output/Kfold_CV/wolfData_wtr_NE_TestData.RData")
  ...
  coug_smr_OK_test_used <- lapply(cougData_smr_OK_test, testing_pts)
  coug_smr_NE_test_used <- lapply(cougData_smr_NE_test, testing_pts)
  coug_wtr_OK_test_used <- lapply(cougData_wtr_OK_test, testing_pts)
  coug_wtr_NE_test_used <- lapply(cougData_wtr_NE_test, testing_pts)
  wolf_smr_OK_test_used <- lapply(wolfData_smr_OK_test, testing_pts)
  wolf_smr_NE_test_used <- lapply(wolfData_smr_NE_test, testing_pts)
  wolf_wtr_OK_test_used <- lapply(wolfData_wtr_OK_test, testing_pts)
  wolf_wtr_NE_test_used <- lapply(wolfData_wtr_NE_test, testing_pts)
  ...
  spearman_out <- rbind(md_smr_SpRankCor, md_wtr_SpRankCor, elk_smr_SpRankCor, 
                        ...
                        wolf_wtr_OK_SpRankCor, wolf_wtr_NE_SpRankCor) 
